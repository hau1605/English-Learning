      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Select
            ...
            onValueChange={(value: 'global' | 'weekly' | 'monthly') => setLeaderboardType(value)}
          >
      ...
      {leaderboardData.length >= 3 && (
        <div className="flex justify-center items-end gap-4 pb-8">
          {[1, 0, 2].map((index) => {
            ...
            const podiumHeight = index === 1 ? 'h-48' : index === 0 ? 'h-36' : 'h-28';
            ...
            return (
              <div key={entry.id} className="text-center flex flex-col items-center">
                {/* Avatar */}
                ...
                {/* Name and Level */}
                <p className="font-semibold text-sm max-w-[100px] truncate">{entry.fullName}</p>
                ...
                {/* Podium */}
                <div className={`w-24 rounded-t-lg flex items-center justify-center mt-3 bg-gradient-to-b ${podiumColors[index]}`} style={{ height: podiumHeight === 'h-48' ? '192px' : podiumHeight === 'h-36' ? '144px' : '112px' }}>
                  <span className="text-white text-4xl font-bold opacity-50">#{index + 1}</span>
                </div>
              </div>
            );
          })}
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-1 text-orange-500">
                      ...
                      <span className="text-sm font-medium">{entry.streakDays}</span>
                    </div>
